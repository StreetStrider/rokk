  ...
  */
  ...
  function Result(props) {
    ...
    return input.map(_nullishCoalesce$3(props.children, function () {
      ...
      return React.createElement('div', {
        className: "Error"
      }, _nullishCoalesce$3(_optionalChain$3([e, 'optionalAccess', function (_) {
        return _.name;
      }]), function () {
        return 'Error';
      }), ": ", _optionalChain$3([e, 'optionalAccess', function (_2) {
        return _2.message;
      }]), React.createElement('br', null), React.createElement('pre', null, e.stack));
    }).extract();
  }
  ...
  setTimeout(function () {
    console.log('x', 1, 2, 3);
    console.warn('x', 5, 6, 7);
    console.error('x', 5, 6, 7);
    throw new TypeError('foo_bar');
  });
})();